  ...
  return (
    <div className="app">
      ...
      <SolutionHero
        ...
        imageAlt="SnapALERT"
        title="SnapALERT®"
        description="SnapALERT® is SnapRISK’s real-time alerting system that notifies clients of active risk events – so you can act fast, stay informed, and reduce potential losses. Address threats before they escalate, take initial action to protect your people and assets, enhance your emergency preparedness, and understand your exposures across all locations instantly."
        solution="snapalert"
      />
