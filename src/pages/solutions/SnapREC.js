  ...
  return (
    <div className="app">
      <SolutionHero
        ...
        imageAlt="SnapREC"
        title="SnapREC®"
        description="SnapREC® allows you to streamline how you track, manage, and act on your property risk improvement opportunities – across your entire portfolio."
        solution="snaprec"
      />
