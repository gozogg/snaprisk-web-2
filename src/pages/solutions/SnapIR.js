  ...
  return (
    <div className="app">
      ...
      <SolutionHero
        ...
        imageAlt="SnapIR"
        title="SnapIR"
        description="Infrared thermographic inspections detect hidden risks, like overheating electrical components, failing mechanical systems, or moisture intrusion—before they cause breakdowns, fires, unplanned shutdowns (business interruption), or costly damage."
        solution="snapir"
      />
